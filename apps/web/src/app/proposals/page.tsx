...
type ProposalsPageViewProps = ReturnType<typeof useProposalsList> & {
  ...
  jsonLd: ReturnType<typeof buildProposalsJsonLd>;
...
type ProposalsMainContentProps = {
  ...
  voteMutation: ReturnType<typeof useProposalsList>["voteMutation"];
  router: ReturnType<typeof useRouter>;
};

type ProposalsMobileHeaderProps = {
  account: string | null | undefined;
  connectWallet: () => void;
  setCreateModalOpen: (open: boolean) => void;
};

function ProposalsMobileHeader({
  account,
  connectWallet,
  setCreateModalOpen,
}: ProposalsMobileHeaderProps) {
  return (
...
function ProposalsRightSidebar({
  inspiration,
  isRolling,
  rollInspiration,
