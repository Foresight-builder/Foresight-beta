...
export default async function TermsPage() {
  ...
  const terms = (langFile as any)?.legal?.terms || {};
  const title = typeof terms?.title === "string" ? terms.title : "Terms of Service";
  const lastUpdated = typeof terms?.lastUpdated === "string" ? terms.lastUpdated : "";
  const sections = Array.isArray(terms?.sections) ? (terms.sections as LegalSection[]) : [];
  return (
