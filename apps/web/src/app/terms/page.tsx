    ...
    <main className="min-h-screen bg-white text-black">
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <section className="space-y-4 mb-8">
          ...
          <p>
            欢迎使用
            Foresight（“我们”或“本平台”）。访问或使用本平台的任何功能即表示你已阅读、理解并同意受本服务条款约束。
            如果你不同意任何条款，请停止使用本平台。
          </p>
        </section>
        ...
        <section className="space-y-4 mb-8">
          ...
          <p>
            你需具备在所在司法辖区使用本平台的合法资格。你可以通过邮箱（OTP/魔法链接）或钱包（如
            MetaMask、Coinbase、OKX、Binance）登录， 并可能进行基于签名的身份验证（如
            SIWE）。你有责任对账户凭证和签名操作进行妥善保管。
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>如有问题或建议，请通过平台内的联系方式与我们取得联系。</p>
        </section>
      </div>
    </main>
  );
